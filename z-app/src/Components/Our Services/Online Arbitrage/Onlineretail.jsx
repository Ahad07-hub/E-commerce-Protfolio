...
import retail from '../images/Arbitrage1.png'
export default function Onlineretail() {
  ...
  return (
    ...
    <div className="wareshouse-heading" data-aos="fade-right"
     data-aos-offset="300" data-aos-duration="2000">
       ...
       <p>Rectify Your Supply Chain Efficiency with <span style={{color:'#00a797'}}> Ecom Gleam</span></p>
